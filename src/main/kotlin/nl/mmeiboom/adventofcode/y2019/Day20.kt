...
object Day20 : Day {
    ...
    override fun part1(): Any {
        val maze = Maze(map)
        return maze.findExit(start = Point(37, 112), exit = Point(75, 2))
//        return maze.findExit(startLocation = Point(9, 2), exitLocation = Point(13,16))
    }
    ...
    private fun Map<Point, Char>.toPortals(): Portals {
