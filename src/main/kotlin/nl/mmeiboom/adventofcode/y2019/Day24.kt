...
//            printMap(currentMap)
    ...
    private fun updateMap(currentMap: Map<Point2D, Char>): Map<Point2D, Char> {
        return currentMap.mapValues { toNewValue(it, currentMap) }
    }

    private fun toNewValue(it: Map.Entry<Point2D, Char>, currentMap: Map<Point2D, Char>): Char {
    ...
    private fun rate(currentMap: Map<Point2D, Char>): BigInteger {
    ...
    private fun generatePoints(): List<Point2D> {
